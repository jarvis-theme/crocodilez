<div class="container">
	<h2 class="myaccount"><i class="fa fa-user"></i> &nbsp;Ubah Profil</h2>
	<a class="btn btn-default back" href="{{URL::previous()}}" title="Kembali"><i class="fa fa-arrow-left"></i> Kembali</a>
	<hr>
</div>
	...
	<div class="row">
		<div class="col-md-3">
			<div class="account">
				...
				<ul class="nav">
					...
					<li class="active"><a>Ubah Profil</a></li>
				</ul>
			</div>
		</div>
		<div id="center_column" class="col-md-9">
			{{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-horizontal'))}}
				...
				<div class="form-group">
					<label for="inputPassword" class="col-md-2 control-label">Ulangi Password</label>
					<div class="col-md-4">
						<input type="password" class="form-control" name="password_confirmation" id="inputPassword" placeholder="Ulangi Password">
					</div>
				</div>
				<hr />
				<div class="form-group">
